...
import formateaFecha from "../helpers/formatearFecha";
...
const ModalFormularioTarea = () => {
  ...
  const { modalFormularioTarea, handleModalTarea, Alerta, mostrarAlerta, submitTarea, clearAlerta, tarea } = useProyectos();
                  ...
                  >
                    ...
                    <div className="mb-5">
                      ...
                      <select
                        ...
                        className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
                        value={prioridad}
                        onChange={({ target: { value } }) => setPrioridad(value)}
                      >
